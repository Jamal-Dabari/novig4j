...
public record OpenMarket(String id, String description, Status status, String type, League league, long volume, String eventId, List<String> outcomeIds, List<Outcomes> outcomes,
